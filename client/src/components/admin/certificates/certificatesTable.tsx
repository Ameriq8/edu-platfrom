        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500" dir="RTL">
              هذه جميع البيانات الخاصة بشهادات الطلاب
            </p>
          </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      ...
                      <td className="px-4 py-4 text-sm font-medium whitespace-nowrapp">
                        <h2 className="font-medium text-gray-800">Iraq</h2>
                      </td>
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <h2 className="font-medium text-gray-800">English Course</h2>
                      </td>
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <h2 className="font-medium text-gray-800">B2 English Course</h2>
                      </td>

                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <h2 className="font-medium text-gray-800">22, 2, 2020</h2>
                      </td>
