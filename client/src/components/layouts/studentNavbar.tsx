...
const navigation = [
  { name: 'المحاضرات', href: '/students' },
  { name: 'القنوات', href: '/students/channels' },
  { name: 'الاخبار', href: '/students/news' },
  { name: 'الملف الشخصي', href: '/students/profile' },
];
          ...
          {navigation.map((item) => (
            <Link
              ...
              className={classNames(
                router.pathname == item.href ? 'border-b border-b-blue-600 hover:rounded' : '',
